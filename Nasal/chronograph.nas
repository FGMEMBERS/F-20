...
var chrono_onoff = props.globals.getNode("sim/model/x-15-1/instrumentation/clock/chronometer-on", 1);
var reset_state = props.globals.getNode("sim/model/x-15-1/instrumentation/clock/reset-state", 1);
var elapsed_sec = props.globals.getNode("sim/model/x-15-1/instrumentation/clock/elapsed-sec", 1);
