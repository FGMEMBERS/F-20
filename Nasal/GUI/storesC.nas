...
var initStoresDialog = func
{
  ...
  image = root_group.createChild("image")
   ...
   load_catalog [outer_left] = [{store : Sniper_pod,
                                    ident : "SniperL",
                                    callback : sniperAndAlqCallback},
								   {store : AIM_120A,
								    ident : "OuterL120",
                                    callback : outerAmraamCallback},
								   {store : AIM_9L,
								    ident : "OuterL9",
   ...
   load_catalog [center] = [{store : Fuel_tank,
							   ...
							   {store : Sniper_pod,
							    ident : "SniperC",
                                callback : centerSniperCallback},
							   {store : ALQ_131,
							    ident : "AlqC",
                                callback : centerAlq131Callback}];
   ...
   load_catalog [outer_right] = [{store : ALQ_131,
	                                 ident : "AlqR",
                                     callback : sniperAndAlqCallback},
								    {store : AIM_120A,
								     ident : "OuterR120",
